...
MacroNex/
├── src/
│   ├── MacroNex.Domain/           # Core business logic and entities
...
│   │
│   ├── MacroNex.Application/      # Application services and use cases
│   │   ├── Services/              # Application services
│   │   ├── UseCases/              # Business workflows
│   │   └── DTOs/                  # Data transfer objects
│   │
│   ├── MacroNex.Infrastructure/   # External adapters
│   │   ├── Adapters/              # Concrete implementations
│   │   ├── Win32/                 # Win32 API integration
│   │   └── Storage/               # File system and JSON serialization
│   │
│   └── MacroNex.Presentation/     # WPF UI layer
...
│
└── tests/
    └── MacroNex.Tests/            # Unit and property-based tests
```
